...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Нажмите на счёт, чтобы пополнить, списать или задать точный баланс.',
  ...
  },
  {
    ...
    items: [
      ...
      'Периодичность: раз в неделю / месяц / год, каждые N месяцев (2, 3, 6, 12, 18, 24) или разовый платёж.',
      'Нажмите на расход, чтобы отметить его оплаченным — сумма спишется с выбранного счёта. Нажмите ещё раз, чтобы отменить.',
      'Свайп влево по расходу — изменить или удалить его.',
